<template>
  <div v-if="landing">
    ...
    <header v-if="landing.banner.media" class="mb-4">
    ...
    <section v-if="landing.gettingStarted[0]" class="content-block">
        <div class="container py-5" :id="landing.gettingStarted[0].anchorpoint ? landing.gettingStarted[0].anchorpoint : ''">
    ...
    <section class="content-block">
      ...
      <div v-if="landing.keyFeaturesText && landing.keyFeatures" class="container">
        <hr class="my-0">
      </div>

      <div class="container py-5" v-if="landing.keyFeatures">
        <div class="row">
    ...
    <section class="content-block">
      ...
      <div v-if="landing.ecosystemText && landing.ecosystem" class="container">
        <hr class="my-0">
      </div>

      <div class="container py-5" v-if="landing.ecosystem">
        <div class="row">
    ...
    <section class="content-block">
      ...
      <div v-if="landing.faqText[0] && landing.faq[0]" class="container">
        <hr class="my-0">
      </div>

      <div class="container py-5" v-if="landing.faq[0]">
        <faq :faq="landing.faq" />
      </div>
    </section>
    <!-- END FaQ -->
